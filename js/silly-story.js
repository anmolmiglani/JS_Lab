...
*/
let storyText = "It was 94 fahrenheit outside, so :insertx: went a walk. When they got to :inserty:, they stared in horror for a few moments, then :insertz:. Bob saw the whole thing, but he was not surprised — :insertx: weighs 300 pounds, and it was a hot day.";
...
let insertZ = ["spontaneously combusted", "rapidly subliated", "evaporated instantly"];
...
function result() {
    ...
    if (document.getElementById("metric").checked) {
        ...
        newStory = newStory.replace("300 ponds", weight + " kilograms");
